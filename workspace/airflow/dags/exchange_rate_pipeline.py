...
from write_2_db import write_2_db
...
write_2_db_task = BashOperator(
        task_id="write_2_db",
        bash_command=write2db,
        dag=dag
    )
...
send_email_task = EmailOperator(
    task_id = 'send_email',
    to = 'Abimbolamuritala65@gmail.com',
...
#Define Task Dependence
download_task >> clean_data_task >> write_2_db_task >> send_email_task